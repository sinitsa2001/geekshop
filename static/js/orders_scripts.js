...
//функционал подстановки цены (динамически) через аякс при выборе товара, и т.д
    //TODO:  не работает - надо разобраться как будет время - какая то проблема видимо с полями
