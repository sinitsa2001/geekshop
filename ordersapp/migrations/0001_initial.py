...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0003_auto_20210110_1705'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен на обработку'), ('PRD', 'обработан'), ('PD', 'оплачен'), ('PDY', 'готов к выдаче'), ('DN', 'выдан'), ('CNC', 'отменен')], default='FM', max_length=3, verbose_name='статус')),
